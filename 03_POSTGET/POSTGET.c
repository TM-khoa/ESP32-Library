...
void httpGET(void) {
    ...
    esp_http_client_config_t config = {
        .url = URL_GETDuLieuGuiXuongBoard,
    ...
    if (err == ESP_OK) {
        ...
        ESP_LOGD(TAG, "response %s", local_response_buffer);
    } else {
...
//     esp_http_client_set_header(client, "User-Agent", "DongTam");
