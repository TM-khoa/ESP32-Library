...
void pwm_init(void)
{
    ESP_LOGI(PWMTAG, "Create timer and operator");
    ...
    ESP_LOGI(PWMTAG, "Connect timer and operator");
    ESP_ERROR_CHECK(mcpwm_operator_connect_timer(oper, timer));

    ESP_LOGI(PWMTAG, "Create comparator and generator from the operator");
    ...
    ESP_LOGI(PWMTAG, "Set generator action on timer and compare event");
    ...
    ESP_LOGI(PWMTAG, "Enable and start timer");
