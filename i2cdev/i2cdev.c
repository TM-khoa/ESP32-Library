...
esp_err_t i2c_dev_readack(const i2c_dev_t *dev, const void *out_data, size_t out_size, void *in_data, size_t in_size)
{
    ...
    if (res == ESP_OK)
    {
        ...
        i2c_master_read(cmd, in_data, in_size, I2C_MASTER_ACK);
